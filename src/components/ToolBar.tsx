...
export default function Toolbar({commands, editorState, editor, contentApi, isGuest} : ToolBarProps) {
	...
	return (
		<>
			<header className="toolbar bg-slate-50 fixed w-6xl top-0 flex flex-row justify-between h-max py-2 px-4 rounded-xl z-1 shadow-lg left-1/2 -translate-x-1/2">
				<nav className="left ">
					<Link className="mr-6" to={`/snippet/user/${user?._id}`}>
              <h2 className='text-2xl text-black font-bold'>Snippets</h2>
					</Link>
					...
					<button onClick={commands.toggleUnderline} className={editorState.isUnderline ? "active" : "" }>
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
					...
					<button onClick={commands.toggleCodeBlock} className={editorState.isCodeBlock ? "active" : "" }>
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
					...
					<button onClick={commands.setParagraph} className={editorState.isParagraph ? "active" : "" }>
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
					...
					<button onClick={commands.toggleOrderedList} className={editorState.isOrderedList ? "active" : "" }>
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
					...
					<button onClick={commands.toggleUnorderedList} className={editorState.isUnorderedList ? "active" : "" }>
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
