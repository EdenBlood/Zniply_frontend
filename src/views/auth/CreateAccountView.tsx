...
export default function CreateAccountView() {
  ...
  const { register, handleSubmit, formState: {errors}, watch, reset } = useForm<CreateAccountFormData>({defaultValues: initialValues});
  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex flex-col gap-2">
          ...
          <input 
            ...
            {...register("password_repeat", {
              ...
              validate: {
                matchPassword: (value : string) => value === password || "Las contraseñas no coinciden"
              }
            })}
          />
        ...
        <InputSubmit
          isPending={isPending}
          values={["Crear Cuenta","Creando Cuenta..."]}
        />
      </form>
