...
import { msgResponseSchema, type CreateAccountFormData, type LoginFormData, type ForgotPasswordFormData, type ResendCodeFormData, type ConfirmTokenFormData, type ChangePasswordFormData, userAuthSchema, userLoginSchema } from "@/types/index"
...
class AuthService {
  ...
  static changePassword = async ({formData, token}: {formData: ChangePasswordFormData, token: ConfirmTokenFormData["token"]}) => {
