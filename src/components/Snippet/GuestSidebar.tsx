      ...
      <nav className="p-4 -my-4 flex flex-col gap-3">
        <div className="p-2 rounded-md w-full max-w-full bg-slate-50 ">
          <p className="text-accent-violet text-sm font-bold text-pretty break-words w-full">
            Guest <span className="text-black">Snippet's</span>
          </p>
        </div>
        ...
        {snippets.length > 0 ? (
          ...
          <Link
            className="block font-normal text-sm p-2 rounded-md text-slate-50 hover:text-violet-300 hover:bg-slate-500/10 text-center transition-colors duration-300"
            to={'/create-snippet/guest'}
          >
        ...
        <div className="rounded-md w-full max-w-full">
          {snippets.length >= 3 ? (
            <Link className="block " to={`/auth/create-account`}>
              <p className="p-2 rounded-md text-gray-300 text-sm font-bold text-pretty w-full text-center hover:text-violet-300 hover:bg-slate-500/10 transition-colors duration-200 group">
                Ya excediste el máximo de Snippets, si no tienes una cuenta crea una{' '}
                <span className="text-accent group-hover:text-accent-violet transition-colors duration-200">
                  Aquí
                </span>
              </p>
            </Link>
          ) : (
            <p className="text-gray-300 text-sm font-bold text-pretty break-words w-full text-center">
              Como invitado podrás tener máximo 3 Snippets
            </p>
          )}
        </div>
      </nav>
